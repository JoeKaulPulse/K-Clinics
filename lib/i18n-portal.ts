...
export const PORTAL_DICT: Record<string, Entry> = {
  ...
  'signup.errAge': { en: 'You must be 18 or over to register with the clinic.', uk: 'Вам має бути 18+, щоб зареєструватися.' },
  ...
  'signup.errLastName': { en: 'Please enter your surname.', uk: 'Будь ласка, введіть своє прізвище.' },
  'signup.errEmail': { en: 'Please enter a valid email.', uk: 'Введіть дійсну електронну пошту.' },
  'signup.errPhone': { en: 'Please enter a contact phone number.', uk: 'Вкажіть контактний номер телефону.' },
  'signup.errDob': { en: 'Please enter your date of birth.', uk: 'Вкажіть свою дату народження.' },
  ...
  'dash.referHeading': { en: 'Refer a friend', uk: 'Запросити друга' },
  'dash.referBody': { en: "Know someone who'd love KClinics? Share your link — you both get £25 credit towards any treatment.", uk: 'Знаєте когось, кому сподобається KClinics? Поділіться посиланням — ви обоє отримаєте £25 кредиту на будь-яку процедуру.' },
  'dash.referCta': { en: 'Share your referral link', uk: 'Поділитися посиланням' },
  ...
  'gender.FEMALE': { en: 'Female', uk: 'Жіноча' },
  'gender.MALE': { en: 'Male', uk: 'Чоловіча' },
  'gender.NON_BINARY': { en: 'Non-binary', uk: 'Небінарна' },
  'gender.OTHER': { en: 'Other (describe)', uk: 'Інша (опишіть)' },
  'gender.PREFER_NOT_TO_SAY': { en: 'Prefer not to say', uk: 'Волію не вказувати' },
  'gender.selfDescribe': { en: 'How do you identify? (optional)', uk: 'Як ви себе ідентифікуєте? (необовʼязково)' },
  ...
  'appt.cancel': { en: 'Cancel', uk: 'Скасувати' },
  'appt.cancelled': { en: 'Cancelled.', uk: 'Скасовано.' },

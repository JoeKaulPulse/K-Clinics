...
export const DICT: Record<string, Entry> = {
  ...
  'nav.compliance': { en: 'Compliance & renewals', uk: 'Відповідність та продовження' },
  'nav.incidents': { en: 'Incidents register', uk: 'Реєстр інцидентів' },
  'nav.contractors': { en: 'Contractors', uk: 'Підрядники' },
  'nav.healthforms': { en: 'Health forms', uk: 'Медичні форми' },
  'nav.devices': { en: 'Devices', uk: 'Пристрої' },
  'nav.tasks': { en: 'Tasks', uk: 'Завдання' },
  'nav.calendar': { en: 'Calendar', uk: 'Календар' },
  'nav.bookings': { en: 'Bookings', uk: 'Записи' },
  'nav.waitlist': { en: 'Waitlist', uk: 'Лист очікування' },
  ...
  'nav.campaignsLegacy': { en: 'Personal-code campaigns', uk: 'Кампанії з персональним кодом' },
  ...
  'nav.connections': { en: 'Channel connections', uk: 'Канали та інтеграції' },
  ...
  'nav.financePlanner': { en: 'Finance planner', uk: 'Фінансовий план' },
  'nav.reports': { en: 'Reports', uk: 'Звіти' },
  'nav.sessionInsights': { en: 'Session insights', uk: 'Аналітика сесій' },
  ...
  'nav.ipActivity': { en: 'IP & device activity', uk: 'IP та пристрої' },
  ...
  'nav.group.website': { en: 'Website', uk: 'Вебсайт' },
  'nav.group.academy': { en: 'K Academy', uk: 'Академія' },

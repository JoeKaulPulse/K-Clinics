...
export const finderQuestions: FinderQuestion[] = [
  {
    ...
    options: [
      { value: 'skin', label: 'Skin quality & glow', suggests: [{ slug: 'hydraglow-facial', weight: 3 }] },
  ...
  },
  {
    ...
    options: [
      { value: 'dullness', label: 'Dullness / uneven tone', suggests: [{ slug: 'hydraglow-facial', weight: 2 }] },
      { value: 'pigmentation', label: 'Pigmentation / sun damage', suggests: [] },

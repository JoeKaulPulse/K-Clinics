...
const STATIC: Omit<PageInput, 'overridden' | 'noindex'>[] = [
  { path: '/', title: 'K Clinics — Aesthetics & Aesthetic Dentistry, Reimagined | Islington, London', description: 'Advanced laser & skin aesthetics and aesthetic dentistry under one roof in Islington, London. Qualified clinicians, bespoke plans — book online today.', keywords: ['aesthetics clinic London', 'aesthetic dentistry Islington', 'laser clinic London'], type: 'home', hasSchema: true, hasFaq: true, ogImage: true },
  { path: '/treatments', title: 'Aesthetic Treatments in London — Laser, Skin & Body | K Clinics', description: 'Explore K Clinics’ full menu of aesthetic treatments in Islington, London — laser hair removal, HIFU lifting, advanced facials, body contouring and injectables.', keywords: ['aesthetic clinic London', 'laser clinic Islington', 'skin treatments London', 'non-surgical treatments'], type: 'hub', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/dentistry', title: 'Aesthetic & General Dentistry in London — Opening Soon | K Clinics', description: 'Aesthetic dentistry coming soon to K Clinics, Islington — porcelain veneers, teeth whitening, composite bonding, dental implants and specialist care. Register your interest.', keywords: ['cosmetic dentist London', 'dental clinic Islington', 'veneers London', 'dental implants London'], type: 'hub', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/pricing', title: 'Price List — Aesthetics & Laser Treatments in London | K Clinics', description: 'Full, transparent price list for K Clinics, Islington — laser hair removal, HIFU, HydraFacial, tattoo and pigmentation removal, injectables and more.', keywords: ['laser hair removal prices London', 'aesthetics prices Islington', 'treatment cost London'], type: 'commerce', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/packages', title: 'Treatment Packages & Programmes in London | K Clinics', description: 'Curated treatment packages at K Clinics, Islington — Total Rejuvenation, Perfect Skin, Smooth & Slim and Ultimate Hair-Free programmes for transformative, lasting results.', keywords: ['treatment packages London', 'skin programme London', 'body sculpting package', 'laser hair removal package'], type: 'commerce', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/offers', title: 'Special Offers & Savings | K Clinics London', description: 'Current offers at K Clinics, Islington — 15% off your first visit, complimentary consultations, refer-a-friend rewards, gift vouchers and savings on treatment packages.', keywords: ['aesthetics offers London', 'first visit discount clinic', 'treatment package savings'], type: 'commerce', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/finance', title: 'Cost & Finance — Flexible Payment Options | K Clinics London', description: 'Spread the cost of your treatment at K Clinics, Islington. Transparent pricing, pay-as-you-go courses, 0% interest-free options and Buy Now, Pay Later with Clearpay and Klarna.', keywords: ['pay monthly aesthetics London', 'buy now pay later clinic', '0% finance treatment', 'Clearpay Klarna clinic'], type: 'commerce', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/gift-vouchers', title: 'Gift Vouchers — Give the Gift of K Clinics | London', description: 'Buy a K Clinics gift voucher online in minutes. Choose any amount from £10 to £500, add a personal message, and we’ll email it instantly or on a date you choose.', keywords: ['K Clinics gift voucher', 'beauty gift card London', 'aesthetics gift voucher', 'gift card Islington clinic'], type: 'commerce', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/book', title: 'Book an Appointment — Islington, London | K Clinics', description: 'Book your appointment at K Clinics, Islington. Create your account for 15% off your first visit; pay only when your treatment is delivered.', keywords: ['book appointment London', 'book aesthetics Islington'], type: 'commerce', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/consultation', title: 'Book a Free Consultation — Islington, London | K Clinics', description: 'Request your complimentary consultation at K Clinics, Islington. Tell us your goals and our expert team will design a bespoke treatment plan. New clients enjoy 15% off.', keywords: ['free consultation London', 'aesthetics consultation Islington', 'book consultation clinic'], type: 'contact', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/ai-consultation', title: 'Get My Plan — AI Skin, Smile & Hair Consultation | K Clinics', description: 'Upload a photo and our AI analyses your skin, smile and hair, then builds a personalised, phased, bookable treatment plan to your budget. Free with a K Clinics account.', keywords: ['AI skin analysis London', 'AI consultation aesthetics', 'personalised treatment plan'], type: 'content', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/treatment-finder', title: 'Treatment Finder — Find Your Ideal Treatment | K Clinics', description: 'Answer a few questions and we’ll recommend the ideal treatments for your goals at K Clinics, Islington, London.', keywords: ['treatment finder London', 'which treatment aesthetics'], type: 'content', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/gallery', title: 'Before & After Gallery | K Clinics London', description: 'Real client before-and-after results from K Clinics, Islington — published only with the client’s consent. Drag any case to reveal the transformation.', keywords: ['before after K Clinics', 'aesthetics results London', 'aesthetic dentistry results Islington'], type: 'content', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/reviews', title: 'Client Reviews — Verified & Genuine | K Clinics', description: 'Read verified client reviews of K Clinics, Islington — the results and the experience, in our clients’ own words.', keywords: ['K Clinics reviews London', 'aesthetics reviews Islington'], type: 'content', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/journal', title: 'The Journal — Expert Skin, Laser & Dentistry Guides | K Clinics London', description: 'Expert guidance from K Clinics, Islington — honest, practical articles on laser, skin, injectables and aesthetic dentistry to help you make confident, informed choices.', keywords: ['aesthetics blog London', 'skincare advice', 'laser hair removal guide', 'aesthetic dentistry tips'], type: 'content', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/about', title: 'About K Clinics — Our Philosophy | Islington, London', description: 'The story and philosophy behind K Clinics — expert-led aesthetics and dentistry in the heart of Islington, London.', keywords: ['about K Clinics London', 'aesthetics clinic story'], type: 'content', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/team', title: 'Our Team — Expert Clinicians | K Clinics London', description: 'Meet the clinicians behind K Clinics, Islington — a team of expert practitioners in aesthetics and dentistry.', keywords: ['aesthetic doctors London', 'clinicians Islington'], type: 'content', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/membership', title: 'Membership & Rewards — Beauty Points | K Clinics London', description: 'Join K Clinics membership and earn Beauty Points on every visit, with member pricing and perks across aesthetics and dentistry.', keywords: ['clinic membership London', 'beauty rewards Islington'], type: 'content', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/refer-a-friend', title: 'Refer a Friend — Give £25, Get £25 | K Clinics London', description: 'Share K Clinics with a friend: they get £25 off their first treatment and you get £25 credit when they visit. Generous, simple, and automatic.', keywords: ['refer a friend', 'K Clinics referral', 'aesthetics referral London'], type: 'content', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/careers', title: 'Careers — Join K Clinics | Islington, London', description: 'Build your career at K Clinics, Islington — a place that invests in its people. See our live vacancies and apply, or send a speculative application.', keywords: ['aesthetics jobs London', 'clinic careers Islington', 'cosmetic dentistry jobs'], type: 'content', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/faq', title: 'Frequently Asked Questions | K Clinics London', description: 'Answers to common questions about treatments, booking, aftercare and payment at K Clinics, Islington, London.', keywords: ['aesthetics FAQ London', 'clinic questions Islington'], type: 'content', hasSchema: true, hasFaq: true, ogImage: true },
  { path: '/contact', title: 'Contact & Find Us — K Clinics, Islington London', description: 'Visit K Clinics in Islington, London. Find our address, opening hours and contact details, or book online in seconds.', keywords: ['clinic Islington London', 'near me', 'contact K Clinics'], type: 'contact', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/clinics', title: 'Our Clinic — Find Us in Islington, London | K Clinics', description: 'Visit K Clinics on the border of the City of London and Islington — 4 Charterhouse Buildings, Goswell Road, EC1M 7AN. Step-free access and minutes from Barbican, Farringdon and Old Street.', keywords: ['K Clinics location', 'aesthetics clinic Islington', 'clinic near Barbican Farringdon'], type: 'contact', hasSchema: true, hasFaq: false, ogImage: true },

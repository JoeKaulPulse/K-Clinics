...
const STATIC: Omit<PageInput, 'overridden' | 'noindex'>[] = [
  ...
  { path: '/academy/funding', title: 'Funding & Finance — Pay for Your Training | K Academy London', description: 'How to pay for aesthetics training at K Academy, Islington: monthly course finance and employer sponsorship now, and an honest guide to government routes not yet open.', keywords: ['aesthetics course funding', 'advanced learner loan aesthetics', 'pay monthly aesthetics training', 'adult skills fund London', 'student funding aesthetics academy'], type: 'academy', hasSchema: true, hasFaq: true, ogImage: true },
  { path: '/academy/policies', title: 'Centre Policies — Learner Policies | K Academy London', description: 'K Academy learner and centre policies: malpractice, appeals, complaints, equality, safeguarding, reasonable adjustments, assessment and quality assurance, health and safety, conduct.', keywords: ['K Academy policies', 'VTCT centre policies', 'aesthetics training appeals policy'], type: 'academy', hasSchema: true, hasFaq: false, ogImage: true },

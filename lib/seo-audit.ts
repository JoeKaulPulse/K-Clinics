...
const STATIC: Omit<PageInput, 'overridden' | 'noindex'>[] = [
  ...
  { path: '/finance', title: 'Cost & Finance — Flexible Payment Options | KClinics London', description: 'Transparent, published pricing at KClinics, Islington — pay-as-you-go treatment courses and 0% interest-free options on eligible treatments.', keywords: ['pay monthly aesthetics London', '0% finance treatment'], type: 'commerce', hasSchema: false, hasFaq: false, ogImage: true },
  ...
  // BLD-1607: five live sitemap pages (app/sitemap.ts) with no STATIC entry, so
  // they never got scored or an admin PageSeo override. Metadata mirrors each
  // page's own generateMetadata()/pageMeta() call.
  { path: '/shop', title: 'Shop — Skincare & Products | KClinics', description: 'Shop clinic-grade skincare and products from KClinics, delivered to your door or collect in clinic.', keywords: [], type: 'commerce', hasSchema: false, hasFaq: false, ogImage: true },
  { path: '/group-bookings', title: 'Group & Party Bookings — Hen Parties | KClinics London', description: 'Book the clinic for your celebration — birthdays, hen and bridal parties, corporate days. A private, luxe aesthetics experience in Islington, London.', keywords: ['group booking aesthetics London', 'birthday party clinic', 'hen party facials London', 'bridal party skincare', 'corporate beauty day'], type: 'commerce', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/academy/bundles', title: 'Course Bundles — Multi-Course Training Pathways | K Academy London', description: 'Multi-course training bundles at K Academy, Islington — combine accredited aesthetics courses into a single pathway at a combined price.', keywords: ['aesthetics course bundle London', 'K Academy training pathway'], type: 'academy', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/academy/funding', title: 'Funding & Finance — Pay for Your Training | K Academy London', description: 'How to pay for aesthetics training at K Academy, Islington: monthly course finance and employer sponsorship available now, with an honest guide to the government funding routes that are not yet open.', keywords: ['aesthetics course funding', 'advanced learner loan aesthetics', 'pay monthly aesthetics training', 'adult skills fund London', 'student funding aesthetics academy'], type: 'academy', hasSchema: true, hasFaq: true, ogImage: true },
  { path: '/academy/policies', title: 'Centre Policies — Learner Policies | K Academy London', description: 'K Academy learner and centre policies: malpractice, appeals, complaints, equality and inclusion, safeguarding, reasonable adjustments, assessment and internal quality assurance, health and safety, conduct and conflicts of interest.', keywords: ['K Academy policies', 'VTCT centre policies', 'aesthetics training appeals policy'], type: 'academy', hasSchema: true, hasFaq: false, ogImage: true },
  { path: '/roadmap', title: 'Roadmap — KClinics', description: 'See what\'s new and what\'s coming next from KClinics.', keywords: ['KClinics roadmap', 'what\'s new', 'coming soon'], type: 'content', hasSchema: false, hasFaq: false, ogImage: true },
];

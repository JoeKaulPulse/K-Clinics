...
const STATIC: Omit<PageInput, 'overridden' | 'noindex'>[] = [
  ...
  { path: '/academy/funding', title: 'Funding & Finance — Pay for Your Training | K Academy London', description: 'Ways to fund your aesthetics training at K Academy, Islington — course finance, employer sponsorship, Advanced Learner Loans and council funding routes.', keywords: ['aesthetics course funding', 'advanced learner loan aesthetics', 'pay monthly aesthetics training', 'adult skills fund London', 'student funding aesthetics academy'], type: 'academy', hasSchema: true, hasFaq: false, ogImage: true },

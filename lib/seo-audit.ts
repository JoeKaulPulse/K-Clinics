...
const STATIC: Omit<PageInput, 'overridden' | 'noindex'>[] = [
  { path: '/', title: 'K Clinics — Aesthetics & Dentistry in Islington, London', description: 'Advanced aesthetics and dentistry in Islington, London. Laser, skin, injectables and smile design — book your appointment online today.', keywords: ['aesthetics clinic London', 'Islington'], type: 'home', hasSchema: true, hasFaq: false, ogImage: true },
  ...
  { path: '/reviews', title: 'Client Reviews — Verified & Genuine | K Clinics', description: 'Read verified client reviews of K Clinics, Islington — the results and the experience, in our clients’ own words.', keywords: ['K Clinics reviews London'], type: 'content', hasSchema: true, hasFaq: false, ogImage: true },

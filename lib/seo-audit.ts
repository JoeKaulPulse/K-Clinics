...
const STATIC: Omit<PageInput, 'overridden' | 'noindex'>[] = [
  ...
  { path: '/academy/policies', title: 'Centre Policies — Learner Policies | K Academy London', description: 'K Academy centre policies: malpractice, appeals, complaints, equality, safeguarding, reasonable adjustments, assessment and quality assurance, health and safety.', keywords: ['K Academy policies', 'VTCT centre policies', 'aesthetics training appeals policy'], type: 'academy', hasSchema: true, hasFaq: false, ogImage: true },

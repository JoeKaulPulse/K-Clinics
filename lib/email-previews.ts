...
export function emailPreviews(): EmailPreview[] {
  ...
  return ([
    ...
    { key: 'customGiftCard', name: 'Custom gift card', group: 'Gifting', description: 'Personalised, designed gift card sent to the recipient (with a shareable card link).', html: E.tmplCustomGiftCard({ recipientName: name, fromName: 'James', amount: '£150', code: 'KC-GV-XXXX-XXXX', message: 'Happy birthday — enjoy something lovely! Love James x', designId: 'noir', viewUrl: '#', claimUrl: '#' }) },

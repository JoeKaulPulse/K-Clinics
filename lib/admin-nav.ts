...
export const navGroups: NavGroup[] = [
  ...
  { heading: 'nav.group.operations', icon: 'operations', items: [
    ...
    { href: '/admin/incidents', key: 'nav.incidents', perm: 'clients.clinical.view', keywords: 'incidents accidents riddor adverse reaction health and safety register h&s report reportable' },
  ] },
  ...
  { heading: 'nav.group.admin', icon: 'admin', items: [
    ...
    { href: '/admin/workspace', key: 'nav.workspace', perm: 'workspace.manage', keywords: 'google workspace email mailbox alias group seat directory' },

...
// wording (version), WHEN (timestamp) and WHERE (source) the affirmative tick
// was captured, not just a bare timestamp. Bump the version whenever the consent
// wording shown to the client (see components/ai/KVision.tsx) changes.

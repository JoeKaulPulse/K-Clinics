...
export const BUILD_BACKLOG: BacklogItem[] = [
  ...
  },
  {
    ...
    notes: [
      'Schema (additive, no @unique): Client gained clientStatus ClientStatus? / clientStatusSetBy String? / clientStatusAt DateTime? / clientStatusReason String?, and a new ClientStatus enum (GREEN/YELLOW/RED), mirroring the existing medicalFlag/patchTestResult pattern. AuditAction gained CLIENT_STATUS_CHANGED.',

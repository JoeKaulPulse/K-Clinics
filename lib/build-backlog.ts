...
export const BUILD_BACKLOG: BacklogItem[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'Out of scope, flagged for a follow-up ticket: app/admin/my-day/page.tsx has a near-identical clinic-wide "whole clinic" booking list for non-today dates (its own separate query, not the ClinicianView component this fix touches), gated the same way on bookings.view alone. Not touched here since My Day is a different page not named in this ticket\'s title or owner ask, but it has the same underlying gap.',
      'Verified: npx tsc --noEmit and npm run build pass clean.',
    ],
  },
];

...
export const BUILD_BACKLOG: BacklogItem[] = [
  ...
  {
    title: 'Broken migrated journal images (403), refund CAS race can double-record, admin remove-without-confirm follow-up', type: 'ERROR', urgency: 'P1', status: 'IN_REVIEW', assignee: 'claude',
    value: 8, effort: 3,

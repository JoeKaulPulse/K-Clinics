...
> A branded, print-ready PDF of this runbook is generated by
> `node scripts/build-workspace-guide.mjs` →
> `KClinics-Workspace-Migration-Guide.pdf` (it sits alongside the Go-Live guide).
> This Markdown file is the source of truth; regenerate the PDF after edits.

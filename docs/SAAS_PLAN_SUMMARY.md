...
> the plan; it does not commit spend (pricing is a separate sign-off under BLD-47).
> Finalised for review 21 Jul 2026 (BLD-304). British English.
...
- **Compliance gate before the first external clinic:** DPA/MSA, ROPA, DPIA,
  sub-processor register, Cyber Essentials, insurance. The data-protection pack is
  merged (`docs/data-protection/`, PR #1084); certification/insurance spend stays
  held until clinic #1 is real.

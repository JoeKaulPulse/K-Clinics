...
const COURSES = [
  {
    ...
    durationText: 'Online theory + 2 practical days + assessment', format: 'Blended: Thinkific theory + practical + VTCT exam',
  ...
  },
  {
    ...
    durationText: 'Online theory + 3 practical days + assessment', format: 'Blended: Thinkific theory + practical + VTCT exam',
    accreditations: ['OFQUAL', 'VTCT', 'CPD'],
  ...
  },
  {
    ...
    durationText: 'Online theory + practical days + VTCT exam', format: 'Blended: Thinkific theory + practical + VTCT exam',
    accreditations: ['OFQUAL', 'VTCT', 'CPD'],
  ...
  },
  {
    ...
    durationText: 'Premium, modular delivery', format: 'Blended: Thinkific theory + practical + exam',
    accreditations: ['CPD'],

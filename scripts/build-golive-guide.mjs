...
render([
  ...
  { tip: 'Without GOOGLE_PLACES_API_KEY only your in-house reviews feed the public rating — no Google reviews appear. Reading all reviews into the admin and replying to them from the dashboard (the Business Profile management API) is a separate add-on, not yet switched on.', label: 'Tip' },

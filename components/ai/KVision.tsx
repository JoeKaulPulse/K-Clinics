          ...
          {stage === 'consent' && (
            <motion.div key="consent" {...fade} className="mx-auto max-w-2xl">
              ...
              <div className="mt-6 space-y-4 rounded-3xl border border-white/10 bg-white/[0.03] p-6 text-sm text-[#cdbfae] backdrop-blur">
                ...
                <p>To generate your plan, your photos are sent to our AI provider (Anthropic, processed in the US under standard contractual clauses) for analysis only — never for advertising.</p>

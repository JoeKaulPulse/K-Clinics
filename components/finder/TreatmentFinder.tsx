            ...
            <div className="mt-8 rounded-[var(--radius-lg)] border border-[var(--color-line)] bg-[var(--color-bone)]/50 p-5">
              {emailSent ? (
                ...
                <>
                  ...
                  >
                    <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" aria-label="Email address for your results" className="min-w-[14rem] flex-1 rounded-full border border-[var(--color-line-strong)] bg-white px-4 py-2.5 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />

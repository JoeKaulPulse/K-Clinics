    ...
    <div className="mt-8 rounded-[var(--radius-xl)] border border-[var(--color-line)] bg-[var(--color-bone)] p-6 md:p-8">
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row">
        <input
          ...
          className="flex-1 rounded-full border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-5 py-3.5 text-lg outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"
        />

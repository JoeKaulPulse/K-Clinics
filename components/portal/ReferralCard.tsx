    ...
    <section className="rounded-[var(--radius-lg)] border border-[var(--color-gold)]/30 bg-gradient-to-br from-[var(--color-gold)]/8 to-transparent p-6">
      ...
      <div className="mt-2 flex flex-wrap items-center gap-2">
        <input
          ...
          className="min-w-0 flex-1 rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-white px-3 py-2.5 font-[family-name:var(--font-mono)] text-sm text-[var(--color-ink)] outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"
        />
        <button
          onClick={copy}

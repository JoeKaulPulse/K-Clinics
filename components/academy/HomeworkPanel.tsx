...
const TONES = {
  ...
  light: { notice: 'text-[var(--color-ink)]', box: 'border-[var(--color-line-strong)] bg-[var(--color-bone)]', head: 'text-[var(--color-stone)]', sub: 'border-[var(--color-line-strong)] bg-[var(--color-porcelain)]', strong: 'text-[var(--color-ink)]', soft: 'text-[var(--color-ink-soft)]', faint: 'text-[var(--color-stone)]', fileLink: 'text-[var(--color-ink-soft)] hover:text-[var(--color-gold-deep)]', attach: 'border-[var(--color-line-strong)] text-[var(--color-ink-soft)] hover:border-[var(--color-gold)]', fileRow: 'text-[var(--color-ink-soft)]', remove: 'text-[var(--color-stone)] hover:text-[var(--color-ink)]', textarea: 'border-[var(--color-line-strong)] bg-white text-[var(--color-ink)] placeholder:text-[var(--color-stone)] focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]' },
} as const;

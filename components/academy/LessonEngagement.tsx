    ...
    <div className="mt-8 grid gap-5 border-t border-[var(--color-line)] pt-7 lg:grid-cols-2">
      ...
      <section>
        ...
        <textarea
          ...
          className="w-full rounded-[var(--radius-md)] border border-[var(--color-line)] bg-white px-3.5 py-3 text-sm leading-relaxed focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)] focus:outline-none"
        />
      </section>

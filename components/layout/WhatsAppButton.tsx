...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full bg-[#25D366] py-3 pl-3 pr-4 text-white shadow-[var(--shadow-soft)] transition-transform hover:scale-105 md:hidden print:hidden"
    >

      ...
      {s.envOnly ? (
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-48 rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-[var(--color-porcelain)] px-3 py-1.5 text-sm focus:border-[var(--color-gold)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold)] focus:outline-none"
          />

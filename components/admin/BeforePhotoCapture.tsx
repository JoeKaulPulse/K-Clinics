          ...
          <div className="mt-3">
            {!shot ? (
              <>
                ...
                <input value={area} onChange={(e) => setArea(e.target.value)} placeholder="Area (e.g. lower legs)" aria-label="Area" className="mb-2 w-full max-w-xs rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-[var(--color-porcelain)] px-2 py-1.5 text-sm" />

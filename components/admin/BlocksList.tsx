    ...
    <div>
      ...
      <div className="mt-6 rounded-[var(--radius-lg)] border border-[var(--color-line)] bg-[var(--color-porcelain)] p-5">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <input className="w-56 rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" value={name} placeholder="Name (e.g. Footer CTA)" aria-label="Block name" onChange={(e) => setName(e.target.value)} />

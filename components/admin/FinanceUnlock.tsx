  ...
  return (
    <div className="mx-auto max-w-sm rounded-[var(--radius-lg)] border border-[var(--color-line)] bg-[var(--color-porcelain)] p-7 text-center shadow-[var(--shadow-soft)]">
      ...
      <input
        ...
        className="mt-5 w-full rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-[var(--color-porcelain)] px-3 py-3 text-center text-2xl tracking-[0.5em] outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"
      />
      {mode === 'set' && (
        <input
          ...
          className="mt-3 w-full rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-[var(--color-porcelain)] px-3 py-3 text-center text-2xl tracking-[0.5em] outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"
        />
      )}

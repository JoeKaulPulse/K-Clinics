      ...
      {data.locations.length > 1 && (
        <label className="mb-5 block text-sm">
          ...
          <select
            ...
            className="mt-1.5 block rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"
          >

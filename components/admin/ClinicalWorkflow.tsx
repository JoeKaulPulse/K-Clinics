            ...
            <li key={i}>
              ...
              {s.capture && (
                <input
                  ...
                  className="mt-1.5 ml-7 w-[calc(100%-1.75rem)] rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-[var(--color-porcelain)] px-3 py-1.5 text-sm outline-none focus:border-[var(--color-gold)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold)]"
                />
              )}
            </li>
          ))}

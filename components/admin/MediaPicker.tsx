    ...
    <div>
      ...
      {assets.length > 0 && (
        <div className="mt-4 flex items-center justify-between gap-3">
          <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search images…" aria-label="Search images" className="w-56 rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-[var(--color-porcelain)] px-3 py-1.5 text-sm outline-none focus:border-[var(--color-gold)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold)]" />
    ...
    <div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <input className="w-full rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold)]" value={value} placeholder="https://… or choose from library" aria-label={label || 'Image URL'} onChange={(e) => onChange(e.target.value)} />
        </div>

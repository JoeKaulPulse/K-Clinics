  ...
  return (
    <div ref={box} className="relative">
      ...
      >
        ...
        {unread > 0 && <span className="absolute -right-1 -top-1 grid h-[18px] min-w-[18px] place-items-center rounded-full bg-[var(--color-gold)] px-1 text-[0.6rem] font-semibold text-[var(--color-ink)]">{unread > 9 ? '9+' : unread}</span>}
      </button>

...
const STATUS: Record<string, string> = { DRAFT: 'bg-[var(--color-bone)] text-[var(--color-stone)]', ACTIVE: 'bg-[var(--color-jade)]/15 text-[var(--color-ink)]', ARCHIVED: 'bg-[var(--color-bone)] text-[var(--color-stone)]' };

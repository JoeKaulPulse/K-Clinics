          ...
          {b.palette.map((c, i) => (
            <div key={i} className="flex items-center gap-3 rounded-[var(--radius-md)] border border-[var(--color-line)] bg-white p-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <input value={c.role} onChange={(e) => setColor(i, { role: e.target.value })} placeholder="Where it's used" aria-label="Colour usage" className="w-full rounded-[var(--radius-sm)] bg-transparent text-xs text-[var(--color-stone)] outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-gold)]" />

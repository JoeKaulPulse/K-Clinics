...
const IMPACT: Record<string, string> = { high: 'bg-[var(--color-jade)]/15 text-[var(--color-ink)]', medium: 'bg-[var(--color-gold)]/20 text-[var(--color-ink)]', low: 'bg-[var(--color-bone)] text-[var(--color-stone)]' };

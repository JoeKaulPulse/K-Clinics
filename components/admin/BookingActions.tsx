        ...
        <div className="rounded-[var(--radius-md)] border border-[var(--color-line)] bg-[var(--color-porcelain)] p-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <input value={amount} onChange={(e) => { setAmount(e.target.value); setConfirmCharge(false); }} inputMode="decimal"
              className="w-28 rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-bone)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />
            {!confirmCharge ? (
            ...
            <div className="mt-3">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <input value={refundReason} onChange={(e) => setRefundReason(e.target.value)} placeholder="Reason (optional)" aria-label="Refund reason"
                  className="min-w-[8rem] flex-1 rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-bone)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />
              </div>
        ...
        <div className="rounded-[var(--radius-md)] border border-[var(--color-line)] p-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <input type="datetime-local" value={newWhen} onChange={(e) => setNewWhen(e.target.value)}
              className="rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />
      ...
      {canManage && active && (
        <div className="rounded-[var(--radius-md)] border border-[var(--color-line)] p-4">
          ...
          <input value={reason} onChange={(e) => setReason(e.target.value)} placeholder="Reason (optional)" aria-label="Cancellation reason"
            className="mb-2 w-full rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />

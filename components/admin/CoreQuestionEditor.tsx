          ...
          <li key={q.id} className="rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-[var(--color-porcelain)] p-3">
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0 flex-1">
                <textarea value={q.prompt} onChange={(e) => edit(i, { prompt: e.target.value })} rows={2} className="w-full rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] px-2 py-1.5 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />

            ...
            <AnimatePresence mode="wait" custom={dir}>
              {i < 0 ? (
                        ...
                        <div key={it.id} className="flex items-center justify-between gap-3 rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-[var(--color-porcelain)] px-3 py-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <input
                              ...
                              className="w-20 rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-2 py-1.5 text-right text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"
                            />
                        ...
                        <li key={it.id} className={`rounded-[var(--radius-md)] border p-4 transition-all ${st?.checked ? 'border-[var(--color-gold)] bg-[var(--color-bone)]' : 'border-[var(--color-line)]'}`}>
                          ...
                          {it.note && (
                            <input
                              ...
                              className="mt-2.5 ml-8 w-[calc(100%-2rem)] rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-1.5 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"
                            />
                          )}
                        </li>
                      );
                ...
                <motion.div key="review" custom={dir} variants={slide} initial="enter" animate="center" exit="exit" transition={trans}>
                  ...
                  <textarea rows={3} value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Anything to flag — variance reasons, faults, incidents…" aria-label="Notes for the manager" className="mt-2 w-full rounded-[var(--radius-md)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-4 py-3 outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />

        ...
        {previewOn ? (
          ...
          <aside className="space-y-4 lg:sticky lg:top-24 lg:self-start">
            <div className={`${card} p-4`}>
              ...
              <input className="w-full rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" value={title} placeholder={initial.path} aria-label="Admin label" onChange={(e) => setTitle(e.target.value)} />
            ...
            <div className={`${card} p-4`}>
              ...
              <div className="space-y-3">
                <div><label className="mb-1 block text-xs text-[var(--color-stone)]">Go live at <span className="text-[var(--color-stone)]">(optional)</span></label><input type="datetime-local" className="w-full rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" value={publishAt} onChange={(e) => setPublishAt(e.target.value)} /></div>
                <div><label className="mb-1 block text-xs text-[var(--color-stone)]">Take down at <span className="text-[var(--color-stone)]">(optional)</span></label><input type="datetime-local" className="w-full rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" value={unpublishAt} onChange={(e) => setUnpublishAt(e.target.value)} /></div>
            ...
            <div className={`${card} p-4`}>
              ...
              <div className="space-y-3">
                <div><label className="mb-1 block text-xs text-[var(--color-stone)]">Page title</label><input className="w-full rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" value={seo.title} onChange={(e) => setSeo((s) => ({ ...s, title: e.target.value }))} placeholder="Defaults to the hero heading" aria-label="Page title" /></div>
                <div><label className="mb-1 block text-xs text-[var(--color-stone)]">Meta description</label><textarea className="w-full rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" value={seo.description} onChange={(e) => setSeo((s) => ({ ...s, description: e.target.value }))} /></div>
            ...
            <div className={`${card} p-4`}>
              ...
              {audit.length === 0 ? <p className="text-sm text-[var(--color-stone)]">No accessibility or SEO issues found.</p> : (
                <ul className="space-y-2 text-sm">
                  {audit.map((a, i) => (
                    <li key={i} className="flex gap-2"><span className={a.level === 'warn' ? 'text-[var(--color-blush-deep)]' : 'text-[var(--color-gold-deep)]'}>{a.level === 'warn' ? '!' : '○'}</span><span className="text-[var(--color-ink-soft)]">{a.text}</span></li>
                  ))}
                </ul>
              )}
            </div>

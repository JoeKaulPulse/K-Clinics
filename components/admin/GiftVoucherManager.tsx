  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search code, name or email…" aria-label="Search gift vouchers" className="ml-auto w-full max-w-xs rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-3 py-1.5 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />
      </div>
            ...
            <div className="min-w-[180px] text-right">
              <div className="flex flex-wrap items-center justify-end gap-1.5 text-xs">
                ...
                <input
                  ...
                  className="w-28 rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-2 py-1 text-xs outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"
                />

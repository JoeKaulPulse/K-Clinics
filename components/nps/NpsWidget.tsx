        ...
        <>
          ...
          {stage === 'comment' && (
            <div className="mt-6 text-left">
              ...
              <textarea value={comment} onChange={(e) => setComment(e.target.value)} rows={3} placeholder="What did we do well, or how could we improve?" className="mt-2 w-full rounded-[var(--radius-md)] border border-[var(--color-line)] bg-white px-4 py-3 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />

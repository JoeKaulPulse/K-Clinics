        ...
        {open && (
          ...
          >
            ...
            <div className="border-t border-[var(--color-line)] p-3">
              ...
              {!token && (
                <input value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email (optional — so we can reply if you leave)" className="mb-2 w-full rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-white px-3 py-2 text-xs outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />
              )}
              {token && msgs.length > 0 && (
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="min-w-0 flex-1 rounded-[var(--radius-sm)] border border-[var(--color-line-strong)] bg-white px-3 py-2 text-sm outline-none focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"
                />

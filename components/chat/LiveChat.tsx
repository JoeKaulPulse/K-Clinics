          ...
          >
            <div className="surface-ink flex items-center justify-between px-4 py-3 text-[var(--color-porcelain)]">
              <div>
                ...
                <p className="mt-1 text-[0.7rem] text-[color-mix(in_oklab,var(--color-porcelain)_65%,transparent)]">We typically reply in a few minutes.</p>
              </div>
            ...
            <div ref={scroller} className="flex-1 space-y-2 overflow-y-auto p-4">
              {msgs.length === 0 && <p className="text-sm text-[var(--color-stone)]">Hi 👋 How can we help with your skin, smile or a booking? Send us a message and our team will reply right here.</p>}
              {msgs.map((m) => (

          ...
          <motion.section key="sign" {...fade}>
            ...
            <div className="mt-5 rounded-[var(--radius-lg)] border border-[var(--color-line)] bg-[var(--color-porcelain)] p-6">
              ...
              <input id="signer-name" value={name} onChange={(e) => setName(e.target.value)} autoComplete="name"
                className="mt-1.5 w-full rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-white px-3 py-3 text-base outline-none transition-colors focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]" />
              ...
              <div className="mt-5">
                ...
                <div className="mt-3">
                  ...
                  <input
                    ...
                    className="mt-1.5 w-full rounded-[var(--radius-sm)] border border-[var(--color-line)] bg-white px-3 py-3 text-base italic outline-none transition-colors focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)]"

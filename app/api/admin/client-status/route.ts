...
export async function POST(req: Request) {
  ...
  // session may only set/clear the traffic-light status for a client they
  // actually have a booking with — ownership check runs against the bookings
  // table directly, same as getClient.

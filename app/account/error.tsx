  ...
  return (
    <div className="grid min-h-[70vh] place-items-center p-6 text-center">
      <div className="max-w-md">
        <p className="text-xs uppercase tracking-[0.16em] text-[var(--color-gold)]">Your account</p>
        ...
        <button onClick={reset} className="mt-5 rounded-full bg-[var(--color-gold)] px-5 py-2.5 text-sm font-medium text-white">Try again</button>
      </div>
    </div>
  );
}

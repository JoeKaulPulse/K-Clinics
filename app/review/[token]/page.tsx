      ...
      <div className="mx-auto flex min-h-screen max-w-xl flex-col justify-center px-6 py-16">
        ...
        {done ? (
          <div className="rounded-[var(--radius-lg)] border border-[var(--color-line)] bg-[var(--color-bone)] p-8 text-center">
            ...
            {googleUrl && (
              <a href={googleUrl} target="_blank" rel="noopener noreferrer" className="mt-6 inline-block rounded-full bg-[var(--color-gold)] px-6 py-3 text-sm font-medium text-white hover:bg-[var(--color-ink)]">

  ...
  return (
    <AdminShell user={session?.email} can={can} locale={locale}>
      ...
      <p className="mt-1 max-w-2xl text-sm text-[var(--color-stone)]">
        ...
        hosting environment; if you clear it, the app falls back to any hosting value. See <a href="/admin/integrations" className="text-[var(--color-gold)] hover:underline">Integrations</a> for live connection status.
      </p>

        ...
        <label className="text-xs text-[var(--color-stone)]">
          ...
          <span className="group relative mt-1 flex items-center">
            ...
            <input name="q" defaultValue={q} placeholder="Client or treatment…"
              className="block h-11 w-56 rounded-full border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] pl-9 pr-4 text-sm outline-none transition-shadow placeholder:text-[var(--color-stone)] focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)] focus:shadow-[0_0_0_3px_color-mix(in_oklab,var(--color-gold)_22%,transparent)]" />
          </span>
        </label>
        <label className="text-xs text-[var(--color-stone)]">
          From
          <input type="date" name="from" defaultValue={from}
            className="mt-1 block h-11 rounded-full border border-[var(--color-line-strong)] bg-[var(--color-porcelain)] px-4 text-sm outline-none transition-shadow focus:border-[var(--color-gold-deep)] focus-visible:ring-2 focus-visible:ring-[var(--color-gold-deep)] focus:shadow-[0_0_0_3px_color-mix(in_oklab,var(--color-gold)_22%,transparent)]" />
        </label>
        <label className="text-xs text-[var(--color-stone)]">
          To

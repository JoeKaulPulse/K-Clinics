  ...
  return (
    <>
      ...
      <PageHero
        ...
        lede="Considered treatments, beautiful smiles and qualified clinicians. At KClinics, we believe aesthetic medicine should feel empowering, welcoming and simple to navigate — for every skin tone, gender and lifestyle."
